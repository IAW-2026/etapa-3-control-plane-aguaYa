...
type Props = {
  ...
  addresses: Array<{ id: string; street: string; city: string }>
}
...
export default function CreateBuyerOrderModal({ isOpen, onClose, onSuccess, buyerId, buyerUserId, vendors, addresses }: Props) {
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Nueva Orden">
      <form onSubmit={handleSubmit} className="space-y-4 text-sm">
        ...
        <div className="flex justify-end gap-2 border-t border-white/20 pt-4 dark:border-slate-700/30">
          ...
          <button
            type="submit"
            disabled={saving || !vendorId || !total}
