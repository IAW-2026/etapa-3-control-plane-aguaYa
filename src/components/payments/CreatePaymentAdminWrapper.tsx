...
import CreatePaymentAdminModal from "./CreatePaymentAdminModal"

export default function CreatePaymentAdminWrapper({ onCreated }: { onCreated: () => void }) {
  ...
  return (
    <>
      ...
      >
        ...
        Nuevo Admin de Pagos
      </button>
      <CreatePaymentAdminModal
        isOpen={open}
